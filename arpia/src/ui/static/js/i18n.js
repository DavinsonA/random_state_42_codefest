...
const DICC = {
    es: {
        ...
        "prov.nota": "Datos de ejemplo: se reemplazan con la respuesta del agente.",
        "prov.tiempo": "Evolución temporal",
        "prov.tiempo.serie": "Eventos (ejemplo)",
        "prov.mapa": "Distribución geográfica",
        "prov.mapa.nota": "Ubicaciones de ejemplo: el corpus aún no trae lugar por documento.",
        "prov.eventos": "Distribución de eventos",
        "prov.relaciones": "Relaciones",
        "prov.relaciones.nota": "Relaciones de ejemplo: el corpus aún no trae actores ni vínculos.",
        "prov.nodo.org": "Organización",
        "prov.nodo.pais": "País A",
        "prov.nodo.empresa": "Empresa B",
    },
    ...
    en: {
        ...
        "prov.nota": "Sample data: replaced by the agent's answer.",
        "prov.tiempo": "Evolution over time",
        "prov.tiempo.serie": "Events (sample)",
        "prov.mapa": "Geographic distribution",
        "prov.mapa.nota": "Sample locations: the corpus does not yet include a place per document.",
        "prov.eventos": "Event distribution",
        "prov.relaciones": "Relationships",
        "prov.relaciones.nota": "Sample relationships: the corpus does not yet include actors or links.",
        "prov.nodo.org": "Organization",
        "prov.nodo.pais": "Country A",
        "prov.nodo.empresa": "Company B",
    },
};
